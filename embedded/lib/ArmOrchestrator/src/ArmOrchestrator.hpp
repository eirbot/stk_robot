...
class ArmOrchestratorInterface: public ActiveObjectInterface {
public:
  ArmOrchestratorInterface(QueueHandle_t &queue_into_object, QueueHandle_t &queue_out_from_object): ActiveObjectInterface(queue_into_object, queue_out_from_object){}; 
